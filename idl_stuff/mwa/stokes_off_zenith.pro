...
function stokes_off_zenith, azimuth_deg, elevation_deg, stokes_zenith, Efield_zenith = Efield_zenith, norm = norm, $
                            frac_unpolarized = frac_unpolarized
  ...
  ;; because we have deal with unpolarized fractions
